...
The resistors R4, R5 and the transistors Q3, Q4 are currently not necessary. They should support a manual overide detection in the futere (currently not yet imlemented in the code).
